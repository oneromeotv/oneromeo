...
export default function EbookPage() {
  const jsonLd = {
    ...
    description:
      'A novel about a young law student caught between expectations and dreams, traveling abroad as drama unfolds.',
    image: 'https://oneromeo.com/ebook.png',
    workExample: {
      '@type': 'Book',
      ...
      potentialAction: {
        ...
        target: {
          '@type': 'EntryPoint',
          urlTemplate: 'https://oneromeo.com/ebook',
          actionPlatform: [
            ...
            <div className="space-y-8 text-center md:text-left">
              <div className="space-y-4">
                ...
                <p className="text-xl text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  I wrote this novel before I ever picked up a camera. It was
                  the time of blogs, not vlogs. The interest in people was
                  already there.
                </p>
              </div>
          ...
          <section className="grid md:grid-cols-2 gap-12 border-t border-zinc-200 dark:border-zinc-800 pt-20">
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg text-zinc-700 dark:text-zinc-300 leading-relaxed">
                <p>
                  At some point, we all need to let something out. For me, it
                  was ink and paper. Writing made my heart lighter and the world
                  more colorful.
                </p>
                <p>
